...
const LEFT_PANEL_ID = "left-panel_01"

const ResizableLayout01 = async () => {
    ...
    <div className="bg-background text-foreground flex h-screen flex-col">
      ...
      <ResizableLayoutProvider initialState={states}>
        <ResizableLayoutGroup direction="horizontal" className="bg-secondary" defaultLayout={sizes}>
          ...
          <ResizableLayoutContent minSize={60} defaultSize={65} maxSize={100} className="relative p-4">
...
export default ResizableLayout01
